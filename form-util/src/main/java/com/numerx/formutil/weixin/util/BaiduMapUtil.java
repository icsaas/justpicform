...
import com.numerx.formutil.weixin.company.entity.BaiduPlace;
import com.numerx.formutil.weixin.company.entity.UserLocation;
import com.numerx.formutil.weixin.message.resp.Article;
...
public class BaiduMapUtil {
	...
	public static List<Article> makeArticleList(List<BaiduPlace> placeList, String bd09Lng, String bd09Lat) {
		// 项目的根路径
		String basePath = "http://42.96.139.34/touchfuture_test/";
	...
	public static UserLocation convertCoord(String lng, String lat) {
		...
		try {
			...
			// 对转换后的坐标进行Base64解码
			location.setBd09Lng(new String(Base64.decodeBase64(jsonObject.getString("x")), "UTF-8"));
			location.setBd09Lat(new String(Base64.decodeBase64(jsonObject.getString("y")), "UTF-8"));
		} catch (Exception e) {
			location = null;
			e.printStackTrace();
		}
