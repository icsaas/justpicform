...
import com.numerx.formutil.weixin.message.resp.*;
...
public class MessageUtil {
	...
	/**
	 *  事件类型：click(点击菜单拉取消息的事件推送)官方文档有问题应为小写click
	 */
	 ...
	 */
	public static final String EVENT_TYPE_PIC_PHOTO_OR_ALUM = "pic_photo_or_album";
	/**
	 ...
	 */
	public static final String EVENT_TYPE_PIC_LOCATION_SELECT = "location_select";
	 ...
	 *  响应消息类型：语音
	 */
	public static final String SEND_MESSAGE_TYPE_VOICE = "voice";
	/**
	 *  响应消息类型：视频
	 */
	public static final String SEND_MESSAGE_TYPE_VIDEO = "video";
	/**
	 *  响应消息类型：音乐
	 */
	public static final String SEND_MESSAGE_TYPE_FILE = "file";
	/**
	 *  响应消息类型：图文
	 */
	 ...
	 *  响应消息类型：图文
	 */
	public static final String SEND_MESSAGE_TYPE_MPNEWS = "mpnews";
	...
	public static Map<String, String> parseXml(HttpServletRequest request) throws Exception {
		...
		// 从request中取得输入流  
		try (InputStream inputStream = new ByteArrayInputStream(request.getQueryString().getBytes("ANSI"))) {
